        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-2xl sm:text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">
                    Get started with Bill<span class="text-indigo-600">Flow</span>
                </h2>
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                    Start managing your clients and invoicing in seconds.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden">
                ...
                <div class="p-6 sm:p-8">
                    <form method="POST" action="{{ route('register') }}" class="space-y-4">
                        ...
                        <div>
                            ...
                            @if ($errors->get('name'))
                                <p class="mt-1.5 text-xs text-rose-600 dark:text-rose-400 flex items-center gap-1">
                                    <span>⚠️</span> {{ $errors->first('name') }}
                                </p>
                            @endif
                        </div>

                        <!-- Email Address (İkonlu) -->
                        <div>
                        ...
                        <!-- Confirm Password (İkonlu) -->
                        <div>
                            <label for="password_confirmation" class="block text-xs font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-300 mb-1.5">
                                Confirm Password
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
                            ...
                            @if ($errors->get('password_confirmation'))
                                <p class="mt-1.5 text-xs text-rose-600 dark:text-rose-400 flex items-center gap-1">
                                    <span>⚠️</span> {{ $errors->first('password_confirmation') }}
                                </p>
                            @endif
                        </div>
